...
impl IotpServer {
    ...
    pub fn incoming(&self) -> impl Iterator<Item = ConnectResult<IotpConnection>> + '_ {
    ...
    fn try_handshake(mut stream: TcpStream) -> ConnectResult<IotpConnection> {
        let mut buf = [0; 4];
